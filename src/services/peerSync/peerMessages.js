...
export const PEER_MESSAGE_TYPES = {
  ...
  EVENT_UPDATE_REQUEST: "event-update-request",
  ...
  PEER_PING: "peer-ping",
  PEER_PONG: "peer-pong",
  PEER_KICKED: "peer-kicked",
  CHAT_MESSAGE: "chat-message",
  LIME_CLICK_REQUEST: "lime-click-request",
  LIME_UPGRADE_REQUEST: "lime-upgrade-request",
  LIME_BUY_UPGRADE_REQUEST: "lime-buy-upgrade-request",
  LIME_STATE: "lime-state",
  LIME_FRUIT_SPAWNED: "lime-fruit-spawned",
  LIME_FRUIT_CLEARED: "lime-fruit-cleared",
  CLICKER_STATE: "clicker-state",
  CLICKER_CLICK_REQUEST: "clicker-click-request",
  CLICKER_BUY_UPGRADE_REQUEST: "clicker-buy-upgrade-request",
  CLICKER_EVENT_CLICK_REQUEST: "clicker-event-click-request",
  CLICKER_ASCEND_REQUEST: "clicker-ascend-request",
  CLICKER_ASCENDED: "clicker-ascended",
};
